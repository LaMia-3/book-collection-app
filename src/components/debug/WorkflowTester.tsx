  ...
  async function addBooksFromGoogleAPI() {
    ...
    for (let i = 0; i < GOOGLE_BOOK_SEARCHES.length; i++) {
      try {
        ...
        // Assign reading status based on index (for 300 books total - 5 reading, 20 dnf, 250 completed, 25 want-to-read)
        ...
        let status: 'reading' | 'completed' | 'want-to-read' | 'dnf' = 'completed';
